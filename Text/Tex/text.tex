...
\todo{tady chybi dost referenci do literatury}
...
\todo{Tady by bylo fajn hodit nejakou matematiku --- napr. reprodukovat ten dukaz proc se energie ty site pomoci jednoho backpropu zmensi.}
...
\section{Application of neural networks in pattern recognition}
...
\todo{prusvih -- vubec tady neni videt proc vlastne neuronovy site souvisej s pattern recognition! Mozna by nebylo od veci dat sem ``application of neural nets to pattern recognition'' a trochu to rozepsat -- jak se pripravuje obrazek pro neurony aby se to dalo sezvejkat, atd.}
...
\todo{tohle by se melo jmenovat mozna jako ``influence of learning algorithm parameters''?}
