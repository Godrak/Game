...
\todo{tadytim sloppyparem se hodne zmenej parametry algoritmu kterej rovna ty slova do odstavcu, beznej vysledek je ze overflow do strany zmizi. Prosim aplikuj i jinde. Druha moznost je pridat hyphenation do slova ktery latex netusi jak rozdelit, to se dela takhle: hyp\-hen\-ation (viz zdrojak)}
